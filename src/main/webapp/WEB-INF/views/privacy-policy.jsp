...
<html data-wf-page="64f615e4cfda04626e2eeeb1" data-wf-site="64f615e4cfda04626e2eee44">
<head>
  <meta charset="utf-8">
...
<div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease-out-quint"
  ...
  <div class="header-image---home black-gradient">
    <div class="container privacy-policy-header-container w-container"></div>
  </div>
      ...
      <div class="terms-card">
        <div class="text-box centered">
          ...
          <div class="rich-text w-richtext">
            <p>Welcome to Plume. This privacy policy describes how our company collects, uses, and shares your personal information when you visit or make a purchase from the website.</p>
            ...
            <p><strong>Personal Data</strong>: When you register, purchase, or use certain features, we may ask for your name, email address, postal address, phone number, and other personal details. This information helps us to provide a personalized experience.</p>
            <p><strong>Usage Data</strong>: This includes information on how our website is accessed and used. This may comprise data such as your computer’s IP address, browser version, the pages visited, time spent on those pages, and other diagnostic data.</p>
            <p><strong>Cookies Data</strong>: We use cookies to track activity on our website and hold certain information. Cookies are files with a small amount of data which may include an anonymous unique identifier. You can instruct your browser to refuse cookies or indicate when a cookie is sent.</p>
            <h3>How We Use Your Data</h3>
            <p><strong>To Provide Services</strong>: We use your personal data to manage your account, to provide services and products you&#x27;ve requested, and to manage and process payments.</p>
            <p><strong>To Communicate</strong>: We may use your data to contact you about updates, promotions, or more information related to our products and services. This may be in the form of emails, SMS, or other forms of communication.</p>
            <p><strong>To Improve User Experience</strong>: Usage data and feedback assist us in understanding how our services are used and help us to enhance the overall user experience.</p>
            <p><strong>For Marketing</strong>: With your permission, we might send you news and promotions about our products and services that may be of interest to you.</p>
            <h3>Data Protection</h3>
            <p><strong>Security</strong>: We employ best practices and a range of security measures to ensure your data is protected against unauthorized access, alteration, disclosure, or destruction.</p>
            <p><strong>Third-party Service Providers</strong>: We may employ third-party services to facilitate our website&#x27;s operation. These third parties have access to your personal data only to perform tasks on our behalf and are obligated not to disclose or use it for other purposes.</p>
            <h3>Third-Party Sharing</h3>
            <p><strong>Non-Selling</strong>: We do not sell or trade your data.</p>
            <p><strong>Legal Requirements</strong>: We may disclose your personal data in the good faith belief that such action is necessary to comply with a legal obligation, protect the safety of our users, or defend against legal claims.</p>
            <h3>Changes to This Policy</h3>
            <p>We advise you to review this Privacy Policy periodically for changes. Changes to this Privacy Policy are effective when they are posted on this page. We will notify users of significant changes via email or website notifications.</p>
            <h3>Your Rights</h3>
            <h5>You have the right to:</h5>
            <p>1. Access the personal data we have about you.</p>
            <p>2. Correct any mistakes in your personal data.</p>
            <p>3. Withdraw consent where we rely on consent to process your personal data.</p>
    ...
    <div class="footer-container w-container">
      <div class="w-layout-grid footer-grid">
        ...
        <div class="footer-links-container">
          ...
          <a href="/index/privacy-policy" aria-current="page" class="footer-link w--current">Privacy Policy</a>
        </div>
        <div class="footer-links-container">
