...
<html data-wf-page="64f615e4cfda04626e2eeeec" data-wf-site="64f615e4cfda04626e2eee44">
<head>
  <meta charset="utf-8">
...
<div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease-out-quint"
  ...
  <div class="header-image---home light-grey">
    <div class="container w-container">
      <div class="terms-card">
        <div class="text-box centered">
          <h1 class="no-margin">Terms &amp; Conditions</h1>
          <div class="spacer _16"></div>
          <p class="paragraph">Last updated September 2023</p>
          <div class="rich-text w-richtext">
            <h3>Acceptance of Terms</h3>
            <p>By accessing and using <strong>Plume</strong>, you confirm that you&#x27;ve read, understood, and agreed to be bound by these Terms &amp; Conditions. If you do not agree with any part of these terms, you are advised to discontinue use of our website immediately.</p>
            <h3>Intellectual Property</h3>
            <p><strong>Ownership</strong>: All content, including but not limited to text, images, graphics, logos, and software, is the exclusive property of Potato Labs Inc., protected by international copyright, trademark, and other intellectual property laws.</p>
            <p><strong>Restrictions</strong>: Reproduction, modification, distribution, or any form of exploitation of the content is strictly prohibited unless explicitly granted by us in writing.</p>
            <h3>User Conduct</h3>
            <p><strong>Respectful Behavior</strong>: Users are expected to behave respectfully, refraining from posting any content that is unlawful, harmful, threatening, abusive, harassing, defamatory, or otherwise objectionable.</p>
            <p><strong>Security</strong>: Users are prohibited from breaching or attempting to breach the security of the website, including accessing data not intended for the user, logging onto a server without authorization, or probing security vulnerabilities.</p>
            <p><strong>No Automation</strong>: Use of any automated system or software to extract data from this website for commercial purposes (&#x27;screen scraping&#x27;) is prohibited.</p>
            <h3>Limitation of Liability</h3>
            <p><strong>No Warranties</strong>: All content on Plume is provided &quot;as is&quot; without warranty of any kind, either express or implied, including, but not limited to, implied warranties of merchantability or fitness for a particular purpose.</p>
            <p><strong>Indemnity</strong>: You agree to defend, indemnify, and hold harmless Potato Labs Inc. and its directors, officers, employees, and agents from and against all claims and expenses arising out of your use of the website.</p>
            <h3>Governing Law</h3>
            <p>This agreement and any disputes related to these terms or the website will be governed by and interpreted according to the laws of Portugal, without regard to its conflict of law principles. Any legal actions will be initiated in the courts of Portugal/Lisbon.</p>
            <h3>Changes to Terms &amp; Conditions</h3>
            <p><strong>Modification Right</strong>: Potato Labs Inc. reserves the right to modify, amend, or change these Terms &amp; Conditions at any time without prior notice.</p>
            <p><strong>User Responsibility</strong>: It&#x27;s the user&#x27;s responsibility to review these terms periodically. Continued use of the website after changes means you agree to be legally bound by the updated terms.</p>
            <h3>Termination</h3>
            <p>We reserve the right to terminate or suspend access to our website, without prior notice, for conduct that we believe violates these Terms &amp; Conditions or is harmful to other users of the website, us, or third parties, or for any other reason at our discretion.</p>
            <h3>Links to Third-Party Websites</h3>
            <p>Our website may contain links to third-party websites. These links are provided for convenience only. We do not endorse or make any representations about such third-party sites, and we are not responsible for their content or accuracy.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="footer-container w-container">
      <div class="w-layout-grid footer-grid">
        ...
        <div class="footer-links-container">
          ...
          <a href="/index/terms" aria-current="page" class="footer-link w--current">Terms &amp; Conditions</a>
