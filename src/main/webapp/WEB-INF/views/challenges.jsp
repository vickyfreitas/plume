                                ...
                                <div class="inner-content">
                                    <div class="inner-content-group">
                                        <div class="page-title-group">
                                            ...
                                            <p class="text-color-grey">Want unlimited challenges? <a
                                    ...
                                    <div class="inner-content-group gap-32px">
                                        <div class="w-layout-grid _3-col-grid art-grid">
                                            <div id="w-node-d70831f5-0deb-c0c8-6d3d-7e89f771d464-6e2eee89"
                                                 class="art-card">
                                                <div class="action-icon w-embed"></div>
                                                    ...
                                                    <a href="#" class="flex-box w-inline-block"
                                                       style="text-align: left">
                                                        ...
                                                        <div class="text-size-small text-weight-semibold"
                                                             style="text-align: left;">✨ Challenge 1
                                                        </div>
                                                    </a>
                                                    <div class="content-wrap">
                                                        <img src="/images/Challenge1Illustration.png"
                                                             class="img-thumbnail" alt="..." width="300">
                                                        <h2 class="heading-style-h5">Welcome!</h2>
                                                        <p class="text-color-grey2 p-desc">Upload 3 pictures taken of
                                                            birds.<br></p>
                                                    </div>
                                                </div>
                                                <a href="#" class="button-3 is-small w-button">10 FEATHERS 🪶</a>
                                            </div>
                                            <div id="w-node-d70831f5-0deb-c0c8-6d3d-7e89f771d474-6e2eee89"
                                                 class="art-card">
                                                ...
                                                <div class="art-card-context vertical">
                                                    <a href="#" class="flex-box w-inline-block">
                                                        ...
                                                        <div class="text-size-small text-weight-semibold"
                                                             style="text-align: left;">✨ Challenge 2
                                                        </div>
                                                    </a>
                                                    <div class="content-wrap">
                                                        <img src="/images/Challenge2Illustration.png"
                                                             class="img-thumbnail" alt="..." width="300">
                                                        <h2 class="heading-style-h5">Early bird</h2>
                                                        <p class="text-color-grey2 p-desc">Capture 2 images of birds
                                                            with brown plumage.<br></p>
                                                    </div>
                                                </div>
                                                <a href="#" class="button-3 is-small w-button">15 FEATHERS 🪶</a>
                                            </div>
                                            <div id="w-node-d70831f5-0deb-c0c8-6d3d-7e89f771d474-6e2eee89"
                                                 class="art-card">
                                                <div class="action-icon w-embed"></div>
                                                <div class="art-card-context vertical">
                                                    <a href="#" class="flex-box w-inline-block">
                                                        ...
                                                        <div class="text-size-small text-weight-semibold"
                                                             style="text-align: left;">✨ Challenge 3
                                                        </div>
                                                    </a>
                                                    <div class="content-wrap">
                                                        <img src="/images/Challenge3Illustration.png"
                                                             class="img-thumbnail" alt="..." width="300">
                                                        <h2 class="heading-style-h5">Make some noise</h2>
                                                        <p class="text-color-grey2 p-desc">Record the calls of 3
                                                            different song birds.<br></p>
                                                    </div>
                                                </div>
                                                <a href="#" class="button-3 is-small w-button">25 FEATHERS 🪶</a>
                                            </div>
                                            <div id="w-node-fe609cca-d830-785f-5805-6e10c1237086-6e2eee89"
                                                 class="art-card">
                                                <div class="action-icon w-embed"></div>
                                                <div class="art-card-context vertical">
                                                    <a href="#" class="flex-box w-inline-block">
                                                        <%--                              <div class="profile-link smaller"><img src="https://uploads-ssl.webflow.com/64f20700ae99f7afc1a08523/64f20701ae99f7afc1a0859e_Ellipse%202-1.png" loading="lazy" alt="" class="profile-link-image"></div>--%>
                                                        <div class="text-size-small text-weight-semibold"
                                                             style="text-align: left;">✨ Challenge 4
                                                        </div>
                                                    </a>
                                                    <div class="content-wrap">
                                                        <img src="/images/Challenge4Illustration.png"
                                                             class="img-thumbnail" alt="..." width="300">
                                                        <h2 class="heading-style-h5">Owl Master</h2>
                                                        <p class="text-color-grey2 p-desc">Capture 1 picture of an owl
                                                            during the night.<br></p>
                                                    </div>
                                                </div>
